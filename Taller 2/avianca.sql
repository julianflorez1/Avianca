...
--3Construya un procedimiento que permita hacer el checking de los pasajeros, para esto se debe pasar
...
create or replace procedure update_checking(idvuelo in integer,idpasajero in integer,tiposilla in varchar2)
 ...
 --punto 4 Construya una vista que dado un id de un vuelo pasado o confirmado, muestre el listado de personal
